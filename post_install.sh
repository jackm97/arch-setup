...
pacman -S --needed git base-devel && cd /home/"$USER" && echo "Enter user password..."  && su "$USER" -c "git clone https://aur.archlinux.org/yay.git" && cd yay && sudo -u "$USER" makepkg -si
cd ..
rm -rf yay
yay -Syu pamac-aur
cd /
